<?php
session_start();
include '../../app.php'; // sesuaikan dengan struktur folder kamu
...
<head>
  ...
  <link rel="icon" href="../../../templates_admin/assets/img/logo.png?v=2" type="image/x-icon" />
  <style>
    :root {
      --primary: #4e73df;
      --secondary: #1cc88a;
    ...
    * {
    ...
    .logo-circle {
      ...
      overflow: hidden; /* Penting untuk lingkaran */
    ...
    .logo-circle img {
      ...
      height: 90px;
      object-fit: contain;
      border-radius: 50%; /* Double safety untuk lingkaran */
    }
    ...
    /* Responsive untuk mobile yang lebih kecil */
  ...
  <div class="login-container">
    <div class="card login-card">
      ...
      <div class="card-header">
        <div class="logo-wrapper">
          <div class="logo-circle">
            <img src="../../templates_admin/assets/img/logo.png?v=2" alt="Logo Inventaris">
          </div>
      ...
      <div class="card-body">
        ...
        <form action="../../action/auth/login.php" method="POST" autocomplete="off">
