...
<head>
  ...
  <!-- Favicons -->
  <link href="./templates_users/assets/img/logo.png" rel="icon">
  <link href="./templates_users/assets/img/apple-touch-icon.png" rel="apple-touch-icon">
  ...
  <link href="./templates_users/assets/vendor/swiper/swiper-bundle.min.css" rel="stylesheet">
